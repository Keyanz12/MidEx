...
<html lang="en">
  <head>
    ...
    <title>Bootstrap Navigation Demo</title>
  ...
  <body>
    ...
    <div class="container mt-5">
      <div id="home" class="mb-5">
        ...
        <p class="lead">This is a simple navigation example using Bootstrap 5.</p>
      </div>
    ...
    <h1>About us</h1>
    <p>This is about page of me struggling to survive this laboratory</p>
</body>
</html>